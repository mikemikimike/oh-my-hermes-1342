...
"""
    ...
    def test_release_product_readiness_cli_summarizes_product_story(self) -> None:
        with TemporaryDirectory() as tmp:
            ...
            self.assertIn("161/161 interventions", gates["routing_precision"]["summary"])
    ...
    def test_release_evidence_bundle_cli_packages_optional_write_artifact(self) -> None:
        with TemporaryDirectory() as tmp:
            ...
            self.assertIn(
                    "Routing precision: 63/63 negative controls, 161/161 interventions "
            ...
            self.assertEqual(payload["summary"]["routing_precision_intervention_passing"], 161)
            self.assertEqual(payload["summary"]["routing_precision_intervention_total"], 161)
